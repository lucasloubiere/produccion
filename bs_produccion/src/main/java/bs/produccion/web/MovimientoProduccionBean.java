...
import bs.produccion.rn.ItemMovimientoProduccionRN;
...
public class MovimientoProduccionBean extends GenericBean implements Serializable {
    ...
    public void agregarItemDetalle(ItemProductoProduccion nItem) {
        try {

            ItemDetalleItemMovimientoProduccion nItemD = itemMovimientoRN.nuevoItemDetalle(nItem);
    ...
    public void eliminarItemDetalle(ItemProductoProduccion ip, ItemDetalleItemMovimientoProduccion nItem) {
